...
```sh
pip install git+https://github.com/webAIdev/webscraping-ai.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/webAIdev/webscraping-ai.git`)
